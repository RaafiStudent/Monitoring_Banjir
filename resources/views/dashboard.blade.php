...
@section('content')
    <section id="home" class="relative pt-32 pb-24 lg:pt-52 lg:pb-40 overflow-hidden bg-[#111827] text-white flex flex-col justify-center min-h-screen">
        ...
        <div class="w-full max-w-[90rem] mx-auto text-center px-4 md:px-8 relative z-10 flex flex-col items-center">
            <div class="inline-flex items-center gap-2 px-6 py-2 rounded-full bg-amber-500 text-slate-900 text-sm font-bold mb-8 shadow-[0_0_20px_rgba(245,158,11,0.5)]">
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    ...
                    <p class="text-slate-500 mt-1 font-medium text-lg">Sinkronisasi terakhir: 2 menit yang lalu</p>
                </div>
                ...
                <div class="flex flex-col gap-6">
                    <div class="bg-white rounded-[1.5rem] border border-slate-100 shadow-xl shadow-slate-200/40 p-6 flex items-center gap-5">
                        ...
                        <div>
                            ...
                            <h3 class="text-4xl font-black text-slate-800 mt-1">120 <span class="text-lg font-bold text-slate-400">cm</span></h3>
                        </div>
                    </div>

                    <div class="bg-gradient-to-br from-orange-500 to-orange-600 rounded-[1.5rem] shadow-xl shadow-orange-500/30 p-6 text-white relative overflow-hidden">
                        ...
                        <p class="text-white/80 text-xs font-bold uppercase tracking-wider mb-1 relative z-10">Status Waspada</p>
                        <h3 class="text-3xl font-black mb-5 relative z-10">SIAGA 2</h3>
                        <div class="w-full bg-black/20 rounded-full h-2 mb-2 relative z-10">
                            <div class="bg-white h-2 rounded-full shadow-[0_0_10px_rgba(255,255,255,0.8)]" style="width: 75%"></div>
                        </div>
                        <p class="text-xs font-medium text-white/90 relative z-10">Tren naik 15% dari jam sebelumnya.</p>
                    </div>
    ...
    <section id="info" class="py-20 bg-white border-t border-slate-200">
        <div class="max-w-7xl mx-auto px-6">
            <h2 class="text-3xl font-black text-slate-900 mb-12 text-center tracking-tight">Tindakan & Mitigasi Bencana</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-white p-8 rounded-[1.5rem] border border-slate-100 shadow-xl shadow-slate-200/30 hover:-translate-y-1 transition-transform duration-300">
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed">Terpantau intensitas hujan tinggi di wilayah hulu. Risiko luapan sungai mencapai jalan utama desa dalam waktu dekat.</p>
                </div>
                <div class="bg-white p-8 rounded-[1.5rem] border border-slate-100 shadow-xl shadow-slate-200/30 hover:-translate-y-1 transition-transform duration-300">
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed">Amankan dokumen penting dan matikan aliran listrik. Segera menuju titik kumpul evakuasi di Balai Desa Kaligangsa.</p>
                </div>
                <div class="bg-white p-8 rounded-[1.5rem] border border-slate-100 shadow-xl shadow-slate-200/30 hover:-translate-y-1 transition-transform duration-300">
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed">BPBD Tegal: <span class="font-bold text-slate-800">112</span><br> Posko Siaga Bencana: <span class="font-bold text-slate-800">0812-3456-7890</span></p>
                </div>
            </div>
        </div>
    </section>
